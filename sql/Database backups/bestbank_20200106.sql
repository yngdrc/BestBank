...
--
-- Host: 127.0.0.1
-- Czas generowania: 06 Sty 2020, 17:33
...
-- Procedury
--
CREATE DEFINER=`bestbank`@`%` PROCEDURE `activateAll` ()  begin
update Customers
set ProfileStatus = 'Active';
update Customers
set ProfileClosingDate = null;
update Adresses 
set AdressStatus = 'Actual';
update Adresses
set AdressChangeDate = null;
update Accounts
...
CREATE DEFINER=`bestbank`@`%` PROCEDURE `closeProfile` (IN `customerIdentityNumber` VARCHAR(30), IN `closeDate` DATE)  begin
...
CREATE DEFINER=`bestbank`@`%` PROCEDURE `registerTransaction_internal` (IN `transactionNumber` CHAR(18), IN `sourceAccountNumber` CHAR(26), IN `targetAccountNumber` CHAR(26), IN `transactionTitle` VARCHAR(100), IN `transactionDate` DATE, IN `amount` DECIMAL(15,2))  begin
...
INSERT INTO `Accounts` VALUES('26123456785647385647382905', 'Personal account', '74062456789', 'My personal account', '5000.00', '2019-11-19', 'Inactive', '2020-01-06');
INSERT INTO `Accounts` VALUES('26123456785647385612341234', 'Savings account', '74062456789', 'My savings', '5000.00', '2019-11-19', 'Inactive', '2020-01-06');
...
INSERT INTO `Adresses` VALUES(1, '74062456789', 'Adress', 'Second', '56', 'a', '94203', 'Beverly Hills', 'United States', '2019-11-19', 'Outdated', '2020-01-06');
INSERT INTO `Adresses` VALUES(2, '74062456789', 'Correspondence adress', 'Second', '56', 'a', '94203', 'Beverly Hills', 'United States', '2019-11-19', 'Outdated', '2020-01-06');
INSERT INTO `Adresses` VALUES(3, '74062456789', 'Registered adress', 'Second', '56', 'a', '94203', 'Beverly Hills', 'United States', '2019-11-19', 'Outdated', '2020-01-06');
...
INSERT INTO `CreditCards` VALUES('4215658072204550', 'Payment card', '26123456785647385647382905', '2023-11-19', '345', '2019-11-19', 'Inactive', '2020-01-06');
INSERT INTO `CreditCards` VALUES('4215654765890767', 'Debit card', '26123456785647385647382905', '2023-11-19', '870', '2019-11-19', 'Inactive', '2020-01-06');
...
INSERT INTO `Customers` VALUES('74062456789', 'willsmith20@netpost.com', 'Smith', 'William', '1974-06-24', '+1', '456567678', 'Mr.', 'wilsmi0011', 'pEanutbutter20', '2019-11-19', 'Inactive', '2020-01-06');
INSERT INTO `Customers` VALUES('76062809876', 'annawhite@netpost.com', 'White', 'Anna', '1976-06-28', '+1', '765654543', 'Mrs.', 'annwhi0022', 'mynamesAnna15', '2019-11-19', 'Active', NULL);
INSERT INTO `Customers` VALUES('22', 'aa@aa.aa', 'Last', 'First', '0000-00-00', '+0', '000000000', 'Mr.', 'firlas0001', '$2y$10$.IpPdWsiL7MbCsaiL.3V5eYAPko7UDDzXB5rTFQzRPR6e97yW3vje', '2019-12-15', 'Active', NULL);
INSERT INTO `Customers` VALUES('100', 'president@usa.gov', 'Trump', 'Donald', '1946-06-14', '1', '100', 'Mr.', 'dontru0001', '$2y$10$41pAmQszWxFSZCuU0J3S7.aoEFEydfavWnpEFYw7g6qGBtzk9HwKK', '2019-11-29', 'Active', NULL);
INSERT INTO `Customers` VALUES('00000000001', 'asfa@gmail.com', 'Malysz', 'Adam', '1924-02-02', '+1', '765654541', 'Mr.', 'adamal0001', '$2y$10$5LqPDQG8B2SKUnNfaR.c6.yOyQWmrEk5oaIhIfEpO21pOSv3zt1Xi', '2019-11-28', 'Active', NULL);
INSERT INTO `Customers` VALUES('101', 'realdonaldtrump@twitter.com', 'Trump', 'Donald', '1111-11-11', '+1', '101', 'Mr.', 'dontru0002', '$2y$10$ixZ5kohI85MRAg3xRVNEhOHPXJAvRTx0Ew49HTMPe7T7oWlnpksma', '2019-12-01', 'Active', NULL);
INSERT INTO `Customers` VALUES('68053045678', 'newwillsmith@netpost.com', 'Smith', 'Will', '1969-04-24', '03020', '777666876', 'Mr.', 'wilsmi0002', '$2y$10$oD1wK7DsIFAlSik70isW2eg8jexARzRuLYi8d5Jy4oC42C6wKNDHu', '2019-12-03', 'Active', NULL);
INSERT INTO `Customers` VALUES('55555555555', 'hdjzjs@gmail.com', 'Koww', 'Adam', '1998-11-28', '+1', '986532659', 'Mr.', 'adakow0001', '$2y$10$cvvNBr67Xyan9.RhLaKvBuY6H/WjkU27a/To0B5E5lob/KHnEpHXK', '2020-01-04', 'Active', NULL);
INSERT INTO `Customers` VALUES('12345678912', 'jankowalski@gmail.com', 'Kowalski', 'Jan', '1998-11-20', '+1', '356298673', 'Mr.', 'jankow0001', '$2y$10$Pi5mA8ybGPCXV//kDXguH.49hs46Yqz.CRoVueTxQX5aoccUIsYom', '2019-12-24', 'Active', NULL);
